    ...
    <section className="">
      <div className="container mx-auto w-full py-20 2xl:px-16 xl:px-16 lg:px-16 md:px-6">
        <div className="py-20 justify-center mx-auto text-center w-[70%]">
          ...
          <h2 className=" 2xl:text-5xl xl:text-5xl lg:text-5xl md:text-4xl sm:text-3xl text-2xl font-extrabold text-primary font-NunitoFont my-4">
            Success <span className="text-blue-500">stories</span> speak louder
          </h2>
          <p className=" 2xl:text-base xl:text-base lg:text-base md:text-base sm:text-base text-sm 2xl:w-[70%] xl:w-[70%] lg:w-[70%] md:w-[90%] sm:w-[90%] w-[95%] text-primary font-Opensans font-normal text-center mx-auto flex">
